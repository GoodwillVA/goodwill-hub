...
import { LayoutDashboard, FolderKanban, CalendarDays, ClipboardList, Users, LogOut } from 'lucide-react'
...
const NAV = [
  ...
  { href: '/accounting-team', label: 'Accounting Team', icon: Users },
]
...
export default function Sidebar({ userEmail }: { userEmail: string }) {
  ...
  return (
    <aside className="w-[21rem] shrink-0 flex flex-col bg-navy-800 border-r border-navy-600 h-screen sticky top-0">
      {/* Brand */}
      <div className="flex flex-col px-5 py-4 border-b border-navy-600 gap-2">
        <img
